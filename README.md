...
* Use `hide` to hide unnecessary data from showing: [/api/cars/0?hide=image](https://cloudflare-json-server.pages.dev/api/cars/0?hide=image) *(currently only works on single object)*
